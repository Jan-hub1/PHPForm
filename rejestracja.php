...
if (isset($_POST['email'])) {
    ...
    foreach($_POST["zainteresowania"] as $index => $option) {
      if ($checkboxOptionsSQL == "") $checkboxOptionsSQL = "("; 
      $checkboxOptionsSQL .= $option.", ";
    }
    if ($checkboxOptionsSQL != "") {
      $checkboxOptionsSQL = rtrim($checkboxOptionsSQL, ","); 
      $checkboxOptionsSQL .= ")";
    }
    ...
    try {
        ...
        if ($polaczenie->connect_errno != 0) {
            ...
            if ($wszystko_OK == true) {
                ...
                if ($polaczenie->query("INSERT INTO pierwsza VALUES (NULL, '$imie', '$nazwisko', '$login', '$haslo1', '$email', '$ulica', '$nr_domu', '$nr_mieszkania', '$kod_pocztowy', '$miasto', '$wyksztalcenie', '$checkboxOptionsSQL')")) {
